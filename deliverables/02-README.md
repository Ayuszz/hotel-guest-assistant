...
**Live demo:** https://hotel-guest-assistant-lilac.vercel.app (Vercel Hobby, Cerebras free tier, replies typically in about a second) · **Live-model eval:** 17/17 scenarios pass on production, median reply 2.9 s, see [evaluation](docs/evaluation.md) · **Docs:** [Architecture](#architecture) · [API examples](docs/api-examples.md) · [Decisions](docs/decisions.md) · [Evaluation](docs/evaluation.md) · [AI tools used](docs/ai-tools-used.md)
