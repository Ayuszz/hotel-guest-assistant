...
| Cerebras (Llama 3.3 70B), Google Gemini | Runtime models inside the product, for intent classification and grounded answering. Cerebras is primary, Gemini a fallback. Not used to write code |
